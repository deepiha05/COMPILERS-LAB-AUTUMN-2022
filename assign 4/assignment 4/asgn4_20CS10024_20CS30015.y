...
%token OPEN_SQUARE_BRACKET CLOSE_SQUARE_BRACKET OPEN_PARENTHESIS CLOSE_PARENTHESIS OPEN_CURLY_BRACKET CLOSE_CURLY_BRACKET 
...
primary_expression: IDENTIFIER
                  ...
                  | OPEN_PARENTHESIS expression PARENTHESIS_CLOSE
...
postfix_expression: primary_expression
                  ...
                  | postfix_expression OPEN_PARENTHESIS argument_expression_list_opt PARENTHESIS_CLOSE
                  ...
                  | postfix_expression DECREMENT
                        { printf("postfix-expression --> postfix-expression --\n"); }
                  | OPEN_PARENTHESIS type_name PARENTHESIS_CLOSE OPEN_CURLY_BRACKET initializer_list CLOSE_CURLY_BRACKET
                        { printf("postfix-expression --> ( type-name ) { initializer-list }\n"); }
                  | OPEN_PARENTHESIS type_name PARENTHESIS_CLOSE OPEN_CURLY_BRACKET initializer_list COMMA CLOSE_CURLY_BRACKET
                        { printf("postfix-expression --> ( type-name ) { initializer-list , }\n"); }
                  ;
...
unary_expression: postfix_expression
                ...
                | SIZEOF OPEN_PARENTHESIS type_name PARENTHESIS_CLOSE
...
cast_expression: unary_expression
               ...
               | OPEN_PARENTHESIS type_name PARENTHESIS_CLOSE cast_expression
...
enum_specifier: ENUM identifier_opt OPEN_CURLY_BRACKET enumerator_list CLOSE_CURLY_BRACKET
                    { printf("enum-specifier --> enum identifier-opt { enumerator-list }\n"); }
              | ENUM identifier_opt OPEN_CURLY_BRACKET enumerator_list COMMA CLOSE_CURLY_BRACKET
                    { printf("enum-specifier --> enum identifier-opt { enumerator-list , }\n"); }
              | ENUM IDENTIFIER
...
direct_declarator: IDENTIFIER
                 ...
                 | OPEN_PARENTHESIS declarator PARENTHESIS_CLOSE
                       { printf("direct-declarator --> ( declarator )\n"); }
                 | direct_declarator OPEN_SQUARE_BRACKET type_qualifier_list_opt assignment_expression_opt CLOSE_SQUARE_BRACKET
                       { printf("direct-declarator --> direct_declarator [ type-qualifier-list-opt assignment-expression-opt ]\n"); }
                 | direct_declarator OPEN_SQUARE_BRACKET STATIC type_qualifier_list_opt assignment_expression CLOSE_SQUARE_BRACKET
                       { printf("direct-declarator --> direct_declarator [ static type-qualifier-list-opt assignment-expression ]\n"); }
                 | direct_declarator OPEN_SQUARE_BRACKET type_qualifier_list STATIC assignment_expression CLOSE_SQUARE_BRACKET
                       { printf("direct-declarator --> direct_declarator [ type-qualifier-list static assignment-expression ]\n"); }
                 | direct_declarator OPEN_SQUARE_BRACKET type_qualifier_list_opt MULTIPLY CLOSE_SQUARE_BRACKET
                       { printf("direct-declarator --> direct_declarator [ type-qualifier-list-opt * ]\n"); }
                 | direct_declarator OPEN_PARENTHESIS parameter_type_list PARENTHESIS_CLOSE
                       { printf("direct-declarator --> direct_declarator ( parameter-type-list )\n"); }
                 | direct_declarator OPEN_PARENTHESIS identifier_list_opt PARENTHESIS_CLOSE
...
designator: OPEN_SQUARE_BRACKET constant_expression CLOSE_SQUARE_BRACKET
...
compound_statement: OPEN_CURLY_BRACKET block_item_list_opt CLOSE_CURLY_BRACKET
...
selection_statement: IF OPEN_PARENTHESIS expression PARENTHESIS_CLOSE statement
                         { printf("selection-statement --> if ( expression ) statement\n"); }
                   | IF OPEN_PARENTHESIS expression PARENTHESIS_CLOSE statement ELSE statement
                         { printf("selection-statement --> if ( expression ) statement else statement\n"); }
                   | SWITCH OPEN_PARENTHESIS expression PARENTHESIS_CLOSE statement
                         { printf("selection-statement --> switch ( expression ) statement\n"); }
                   ;

iteration_statement: WHILE OPEN_PARENTHESIS expression PARENTHESIS_CLOSE statement
                         { printf("iteration-statement --> while ( expression ) statement\n"); }
                   | DO statement WHILE OPEN_PARENTHESIS expression PARENTHESIS_CLOSE SEMICOLON
                         { printf("iteration-statement --> do statement while ( expression ) ;\n"); }
                   | FOR OPEN_PARENTHESIS expression_opt SEMICOLON expression_opt SEMICOLON expression_opt PARENTHESIS_CLOSE statement
                         { printf("iteration-statement --> for ( expression-opt ; expression-opt ; expression-opt ) statement\n"); }
                   | FOR OPEN_PARENTHESIS  declaration expression_opt SEMICOLON expression_opt PARENTHESIS_CLOSE statement
